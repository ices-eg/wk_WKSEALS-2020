...
## Demo data
When cloning the repository and installing the *rSPAMM* R package a demo data set is installed. In addition a full data set is available in the *wk_WKSEALS-2020/data/Norway/* folder. 
...
```{r eval=FALSE}
dataPath1 = "../../../../data/Norway/"
dataPath2 = "../../../../../data/Norway/"
population = "harpeast"
dataFiles = paste0(dataPath1,population)
data <- load.data(population = dataFiles)
```
**If dataPath1 does not work, try changing to dataPath2. Most importantly, you just want to specify the path to reflect where your data is stored**.
